...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { name: @position.name, publication_id: @position.publication_id } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { name: @position.name, publication_id: @position.publication_id } }
